...
import type { StandardIncomeDao } from '.'
import {
...
export const insertStandardIncomeTable =
  (db: D1Database): StandardIncomeDao['insertStandardIncomeTable'] =>
  async (entity) => {
...
export const updateStandardIncomeTableName =
  (db: D1Database): StandardIncomeDao['updateStandardIncomeTableName'] =>
  async (props) => {
...
export const updateStandardIncomeTableGrades =
  (db: D1Database): StandardIncomeDao['updateStandardIncomeTableGrades'] =>
  async (props) => {
...
export const listStandardIncomeTables =
  (db: D1Database): StandardIncomeDao['listStandardIncomeTables'] =>
  async (props) => {
    const query = d1(db)
      .select(StandardIncomeTableRecord, 'standard_income_tables')
